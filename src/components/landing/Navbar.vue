...
import { SignedOut, SignedIn, UserButton, SignInButton, SignUpButton } from "vue-clerk";
import ThemeToggle from "../ThemeToggle.vue";
</script>

<template>
  <nav class="bg-transparent backdrop-blur-sm border-gray-200 fixed w-full z-10">
