...
const presenters = ref<Presenter[]>([
  {
    id: '1',
    name: 'Dr. Jane Smith',
    about: 'Expert in Machine Learning and Neural Networks',
  ...
  },
  {
    id: '2',
    name: 'Prof. John Doe',
    about: 'Specializes in Data Science and Big Data Analytics',
  ...
  },
  {
    ...
    about: 'Research focuses on Artificial Intelligence and Robotics',
...
const filteredPresenters = computed(() => {
  ...
  return presenters.value.filter(presenter => 
...
<template>
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <h1 class="page-title">Presenters</h1>
      <button
        @click="showPresenterForm = true"
            ...
            <tr v-for="presenter in filteredPresenters" :key="presenter.id">
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <img :src="presenter.avatar" :alt="presenter.name" class="h-10 w-10 rounded-full" />
                  <div class="ml-4">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                {{ presenter.lastEvent ? new Date(presenter.lastEvent).toLocaleDateString() : 'No events yet' }}
              </td>
