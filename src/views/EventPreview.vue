...
const event = ref({
  ...
  description: 'Join us for an engaging seminar on the latest advances in machine learning and their applications in real-world scenarios.',
  date: 'March 20, 2024',
...
const logos = ref([
  { id: '1', url: '/default-logo.png', name: 'Default Logo' }
])
    ...
    <div ref="previewRef" class="card p-8 bg-gradient-to-br from-white to-gray-50">
      <div class="text-center mb-12">
        <div class="mb-6">
          ...
          <div v-else class="w-16 h-16 mx-auto rounded-lg bg-gradient-to-r from-primary-500 to-secondary-500 flex items-center justify-center text-white text-2xl font-bold">
            U
          </div>
        </div>
        <h2 class="text-4xl font-bold bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent mb-4">
          {{ event.title }}
        </h2>
        <p class="text-xl text-gray-600">You are cordially invited to attend</p>
      </div>
      ...
      <div class="max-w-2xl mx-auto space-y-8">
        ...
        <div class="grid grid-cols-2 gap-8">
          <div class="text-center p-6 bg-primary-50 rounded-xl border border-primary-100">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mb-4 text-primary-500" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd" />
            </svg>
            <h3 class="font-semibold text-gray-800 mb-3">Date & Time</h3>
          ...
          <div class="text-center p-6 bg-secondary-50 rounded-xl border border-secondary-100">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mb-4 text-secondary-500" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="space-y-4">
          ...
          <div class="text-center bg-gray-50 rounded-xl p-6 border border-gray-100">
            <div class="flex items-center justify-center gap-2 mb-6">
              <h3 class="font-semibold text-gray-800">Event Team</h3>
              <span class="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">
                {{ attendeeCount }} Registered Attendees
              </span>
            </div>
