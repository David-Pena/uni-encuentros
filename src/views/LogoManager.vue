  ...
  files.forEach(file => {
    ...
    reader.onload = (e) => {
      ...
      if (logos.value.length >= 5) {
        errorMessage.value = 'Maximum 5 logos allowed. Please remove some before adding more.'
        return
      }
  ...
  <div class="space-y-6">
    ...
    >
      <div class="text-center">
        ...
        <h3 class="mt-2 text-sm font-medium text-gray-900">Upload your logos</h3>
        <p class="mt-1 text-sm text-gray-500">PNG only, max 5MB per file</p>
